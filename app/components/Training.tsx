export default function Training() {
    return (
        <section id="training" className="py-5 border-top bg-light">
        ...
        <div className="card training-card h-100 shadow-sm border-0">
          <div className="card-body">
            <div className="d-flex align-items-center mb-3">
              ...
              <h5 className="card-title mb-0">AWS Certified Solutions Architect</h5>
            </div>
      ...
      <div className="col-md-6 col-lg-4">
        <div className="card training-card h-100 shadow-sm border-0">
          <div className="card-body">
            <div className="d-flex align-items-center mb-3">
              <i className="bi bi-patch-check-fill text-primary fs-3 me-3"></i>
              <h5 className="card-title mb-0">React & Next.js Advanced Workshop</h5>
            </div>
            <p className="card-text text-muted">
      ...
      <div className="col-md-6 col-lg-4">
        <div className="card training-card h-100 shadow-sm border-0">
          <div className="card-body">
            <div className="d-flex align-items-center mb-3">
              <i className="bi bi-patch-check-fill text-primary fs-3 me-3"></i>
              <h5 className="card-title mb-0">Data Science & AI Bootcamp</h5>
            </div>
            <p className="card-text text-muted">
